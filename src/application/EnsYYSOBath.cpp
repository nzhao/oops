...
ECenter create_defect_center(const po::variables_map& para);
...
int  main(int argc, char* argv[])
{
    ...
    ECenter es = create_defect_center(para);  
    sol.set_defect_center(&es);
...
{/*{{{*/
    ...
    string output_filename("EnsYYSOBath");
    string command_opt("");
    ...
    INPUT_PATH  = PROJECT_PATH + "/dat/input/YSO/";
    ...
    desc.add_options()
        ...
        ("input,i",          po::value<string>()->default_value("YSOCoord_500.xyz"), "Input file name")
